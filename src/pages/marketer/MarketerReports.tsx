...
import { 
  LayoutDashboard, Video, Upload, Settings, FileText, Download,
  Calendar, Filter, BarChart3, PieChart, TrendingUp
} from "lucide-react";
...
const performanceData = [
  { campaign: "Summer Sale 2024", impressions: 45280, completions: 41102, spend: 6165 },
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-6">
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold">164,980</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold">149,352</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold">$22,402</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="h-[300px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={weeklyTrend}>
                        ...
                        />
                        <Legend />
                        <Line yAxisId="left" type="monotone" dataKey="views" stroke="hsl(var(--primary))" strokeWidth={2} name="Views" />
                        <Line yAxisId="right" type="monotone" dataKey="spend" stroke="hsl(var(--orange-600))" strokeWidth={2} name="Spend ($)" />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                </CardContent>
              ...
              <Card className="card-elevated">
                <CardHeader className="flex flex-row items-center justify-between">
                  <CardTitle className="text-lg">Reward Type Distribution</CardTitle>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <p className="text-3xl font-bold text-green-700">147,234</p>
                    <p className="text-sm text-green-600">98.6% success rate</p>
                  </div>
                  <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                    <p className="text-sm text-red-600">Failed Rewards</p>
                    <p className="text-3xl font-bold text-red-700">1,892</p>
                    <p className="text-sm text-red-600">1.3% failure rate</p>
                  </div>
                  <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <p className="text-sm text-yellow-600">Pending Retry</p>
                    <p className="text-3xl font-bold text-yellow-700">226</p>
                    <p className="text-sm text-yellow-600">0.1% pending</p>
                  </div>
                </div>
              </CardContent>
            </Card>
